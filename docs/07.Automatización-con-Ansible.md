...
Para automatizar la conversión de una VM vacía en un nodo de Kubernetes, hemos desarrollado el playbook `install-k8s-node.yml`. Este script garantiza que todos los nodos tengan exactamente la misma configuración y versiones de software.
...
### 10.1 Asignación de Roles (Opcional)
