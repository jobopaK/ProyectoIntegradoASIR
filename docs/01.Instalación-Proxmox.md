...
---
**[Siguiente Paso:](./02.Configuración-Proxmox-e-instalación-UbuntuServer.md)** Una vez dentro del panel web, procederemos a la creación de las máquinas virtuales para el Control Plane y los Workers de nuestro clúster.
